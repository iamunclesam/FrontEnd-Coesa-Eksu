                ...
                <div class="col">
                    <button type="button"
                        ...
                        <div v-if="userDetails[0].profileImg" class="">
                            <img class="md:w-40 md:h-40 w-28 h-28 rounded-full" :src="userDetails[0].profileImg"
                                alt="user photo">
                        </div>

                        <div v-else>
                            <span class="pt-8 bg-purple-900 text-white text-semibold text-8xl rounded-full w-40 h-40"
