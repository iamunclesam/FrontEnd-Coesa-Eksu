    ...
    <main>
      <div class="flex justify-center align-center items-center text-center">
          <div class="md:m-40 md:mt-20 m-10 text-center">
              ...
              <p class="text-gray-500 mt-10">We've sent an email to {{userProfile.email}} to confirm the validity of your email address. After recieving the email, follow the link provided to change your password</p>
